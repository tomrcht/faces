...
protocol HomeBuilder {
    ...
    var stacksController: UIViewController { get }
}
...
final class HomeComponent: Component<EmptyDependency>, HomeBuilder {
    ...
    var stacksController: UIViewController { stacksBuilder.stacksViewController }
    ...
    private var stacksBuilder: StacksBuilder { StacksComponent(parent: self) }
}
